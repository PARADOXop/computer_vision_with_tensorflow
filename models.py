...
'''This is good way to use deep learning model because it is flexible with I/P and O/P
    easy to manipulate the parameters with ease'''
def Functinal_model():
    ...
    print("*********************************************************************************************")
    print("USING function that returns a model")
    print("*********************************************************************************************")
...
# tensorflow.keras.Model : inherits from this class
...
class MyCustomModel(tf.keras.Model):
    ...
    def __init__(self):
        ...
        print("*********************************************************************************************")
        print("USING inherits from this class")
        print("*********************************************************************************************")
        ...
        self.globlaavg1 = GlobalAvgPool2D()
